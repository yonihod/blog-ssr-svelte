...
<div class="flex items-center gap-3">    
    <a class="social-icon" href="https://twitter.com/yonihod199" target="__blank">
        <BrandTwitter/>
    </a>
    <a class="social-icon" href="https://github.com/yonihod"><BrandGithub/></a>
    <a class="social-icon" href="https://stackoverflow.com/users/1759249/yoni-hodeffi">
